...
# -*- coding: utf-8 -*-
#
# Argbash documentation build configuration file, created by
# sphinx-quickstart on Wed Sep  2 11:02:30 2015.
#
...
# of the sidebar.
LOGO_STEM = os.path.join('..', 'resources', 'logo', '')
html_logo = LOGO_STEM + 'logo.svg'
...
# the title page.
latex_logo = LOGO_STEM + 'argbash.png'
...
texinfo_documents = [
  (master_doc, 'Argbash', 'Argbash Documentation',
   author, 'Argbash', 'One line description of project.',
   'Miscellaneous'),
]
